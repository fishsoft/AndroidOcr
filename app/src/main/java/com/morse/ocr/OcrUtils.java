...
public class OcrUtils extends TestCase {
    ...
    private static final int DEFAULT_PAGE_SEG_MODE = PageSegMode.PSM_SINGLE_BLOCK;
    ...
    protected void setUp() throws Exception {
        ...
        for (String languageCode : DEFAULT_LANGUAGE.split("\\+")) {
            if (!languageCode.startsWith("~")) {
                ...
                assertTrue("Make sure that you've copied " + languageCode + ".traineddata to "
                        + TESSDATA_PATH, expectedFile.exists());
            }
        }
    }
    ...
    private void checkCubeData() {
        ...
        for (String expectedFilename : EXPECTED_CUBE_DATA_FILES_ENG) {
            ...
            assertTrue("Make sure that you've copied " + expectedFilename + " to " + expectedFilePath,
                    expectedFile.exists());
        }
    }
    ...
    public void testChoiceIterator() {
        ...
        final Bitmap bmp = this.getTextImage(inputText, 640, 480);
        ...
        baseApi.setVariable(VAR_SAVE_BLOB_CHOICES, VAR_TRUE);
    ...
    public void testGetHOCRText_tesseract() {
        testGetHOCRText(DEFAULT_LANGUAGE, OEM_TESSERACT_ONLY);
    }
    ...
    public void testGetUTF8Text_tesseract() {
        testGetUTF8Text(DEFAULT_LANGUAGE, OEM_TESSERACT_ONLY);
    }
    ...
    public void testProgressValues_setRectangle() {
        ...
        baseApi.setPageSegMode(PageSegMode.PSM_SINGLE_LINE);
        baseApi.setVariable(VAR_CHAR_WHITELIST,
    ...
    private static void testProgressValues(TessBaseAPI.ProgressValues progress, Rect bounds) {
    ...
    public void testSetImage_file() throws IOException {
        ...
        bmp.compress(Bitmap.CompressFormat.JPEG, 85, fileStream);
    ...
    public void testSetPageSegMode() {
        ...
        final int newPageSegMode = PageSegMode.PSM_SINGLE_CHAR;
    ...
    public void testSetRectangle() {
        ...
        baseApi.setVariable(VAR_CHAR_WHITELIST, leftInput + rightInput);
        baseApi.setImage(bmp);
    ...
    public void testSetVariable() {
        ...
        baseApi.setVariable(VAR_CHAR_BLACKLIST, blacklistedCharacter);
        baseApi.setImage(bmp);
        final String outputText = baseApi.getUTF8Text();
